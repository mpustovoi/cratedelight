...
public record VertexFormatElement(int id, int index, VertexFormatElement.Type type, VertexFormatElement.Usage usage, int count) {
    ...
    public static Stream<VertexFormatElement> elementsFromMask(int pMask) {
        return ELEMENTS.stream().filter(p_350573_ -> p_350573_ != null && (pMask & p_350573_.mask()) != 0);
    }
    ...
    public static enum Usage implements net.neoforged.fml.common.asm.enumextension.IExtensibleEnum {
        ...
        private Usage(String pName, VertexFormatElement.Usage.SetupState pSetupState) {
            this.name = pName;
