    ...
    public void tesselate(BlockAndTintGetter pLevel, BlockPos pPos, VertexConsumer pBuffer, BlockState pBlockState, FluidState pFluidState) {
        ...
        if (flag1 || flag2 || flag6 || flag5 || flag3 || flag4) {
            ...
            if (flag1 && !isFaceOccludedByNeighbor(pLevel, pPos, Direction.UP, Math.min(Math.min(f8, f10), Math.min(f9, f7)), blockstate1)) {
                ...
                float f29 = f4 * f1;
                float f30 = f4 * f2;
                this.vertex(pBuffer, f36 + 0.0F, f37 + f8, f38 + 0.0F, f57, f29, f30, alpha, f17, f21, l);
                this.vertex(pBuffer, f36 + 0.0F, f37 + f10, f38 + 1.0F, f57, f29, f30, alpha, f18, f22, l);
                this.vertex(pBuffer, f36 + 1.0F, f37 + f9, f38 + 1.0F, f57, f29, f30, alpha, f19, f23, l);
                this.vertex(pBuffer, f36 + 1.0F, f37 + f7, f38 + 0.0F, f57, f29, f30, alpha, f20, f24, l);
            ...
            if (flag2) {
                ...
                float f48 = f3 * f1;
                float f50 = f3 * f2;
                this.vertex(pBuffer, f36, f37 + f16, f38 + 1.0F, f46, f48, f50, alpha, f40, f43, k);
                this.vertex(pBuffer, f36, f37 + f16, f38, f46, f48, f50, alpha, f40, f42, k);
                this.vertex(pBuffer, f36 + 1.0F, f37 + f16, f38, f46, f48, f50, alpha, f41, f42, k);
                this.vertex(pBuffer, f36 + 1.0F, f37 + f16, f38 + 1.0F, f46, f48, f50, alpha, f41, f43, k);
            }
