        ...
        return BehaviorBuilder.create(
            p_259997_ -> p_259997_.group(
                    ...
                    .apply(p_259997_, (p_259831_, p_259115_, p_259521_, p_259223_) -> (p_352718_, p_352719_, p_352720_) -> {
                            ...
                            boolean flag = blockpos.closerThan(p_352719_.blockPosition(), (double)pCloseEnoughDist);
                            if (!flag) {
                                BehaviorUtils.setWalkAndLookTargetMemories(p_352719_, getNearbyPos(p_352719_, blockpos), pSpeedModifier, pCloseEnoughDist);
                            }
