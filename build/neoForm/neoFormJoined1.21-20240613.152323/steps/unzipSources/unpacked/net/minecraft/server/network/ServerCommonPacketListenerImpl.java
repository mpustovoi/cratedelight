...
public abstract class ServerCommonPacketListenerImpl implements ServerCommonPacketListener {
    ...
    public void disconnect(DisconnectionDetails pDisconnectionDetails) {
        this.connection.send(new ClientboundDisconnectPacket(pDisconnectionDetails.reason()), PacketSendListener.thenRun(() -> this.connection.disconnect(pDisconnectionDetails)));
