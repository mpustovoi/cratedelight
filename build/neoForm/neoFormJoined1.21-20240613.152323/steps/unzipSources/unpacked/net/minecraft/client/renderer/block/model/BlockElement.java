...
public class BlockElement {
    ...
    public BlockElement(Vector3f pFrom, Vector3f pTo, Map<Direction, BlockElementFace> pFaces, @Nullable BlockElementRotation pRotation, boolean pShade, net.neoforged.neoforge.client.model.ExtraFaceData faceData) {
        this.from = pFrom;
        this.to = pTo;
        this.faces = pFaces;
