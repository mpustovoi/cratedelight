...
public class BlockModel implements UnbakedModel {
    ...
    public BakedModel bake(
            ModelBaker pBaker, BlockModel pModel, Function<Material, TextureAtlasSprite> pSpriteGetter, ModelState pState, boolean pGuiLight3d
    ) {
        return net.neoforged.neoforge.client.model.geometry.UnbakedGeometryHelper.bake(this, pBaker, pModel, pSpriteGetter, pState, pGuiLight3d);
    }
    ...
    public static BakedQuad bakeFace(
        ...
        return FACE_BAKERY.bakeQuad(pElement.from, pElement.to, pFace, pSprite, pFacing, pState, pElement.rotation, pElement.shade);
    }
