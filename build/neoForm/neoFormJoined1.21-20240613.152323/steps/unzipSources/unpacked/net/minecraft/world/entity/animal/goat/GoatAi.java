...
public class GoatAi {
    ...
    private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat()
        .selector(p_352804_ -> !p_352804_.getType().equals(EntityType.GOAT) && p_352804_.level().getWorldBorder().isWithinBounds(p_352804_.getBoundingBox()));
            ...
            ImmutableList.of(
                Pair.of(
                    ...
                    new RamTarget(
                        ...
                        3.0F,
                        p_348297_ -> p_348297_.isBaby() ? 1.0 : 2.5,
