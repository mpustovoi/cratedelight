    ...
    public MultiLineTextWidget(int pX, int pY, Component pMessage, Font pFont) {
        ...
        this.cache = Util.singleKeyCache(
            p_352660_ -> p_352660_.maxRows.isPresent()
                    ? MultiLineLabel.create(pFont, p_352660_.maxWidth, p_352660_.maxRows.getAsInt(), p_352660_.message)
                    : MultiLineLabel.create(pFont, p_352660_.message, p_352660_.maxWidth)
        );
        this.active = false;
    }
