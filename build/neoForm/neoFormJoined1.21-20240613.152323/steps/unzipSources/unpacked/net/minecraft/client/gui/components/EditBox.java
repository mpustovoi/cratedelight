    ...
    public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        if (this.isVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                l = pGuiGraphics.drawString(this.font, this.formatter.apply(s1, this.displayPos), j, k, l1, this.textShadow);
            }
            ...
            if (!s.isEmpty() && flag && i < s.length()) {
                pGuiGraphics.drawString(this.font, this.formatter.apply(s.substring(i), this.cursorPos), l, k, l1, this.textShadow);
            }

            if (this.hint != null && s.isEmpty() && !this.isFocused()) {
                pGuiGraphics.drawString(this.font, this.hint, l, k, l1, this.textShadow);
            }

            if (!flag2 && this.suggestion != null) {
                pGuiGraphics.drawString(this.font, this.suggestion, j1 - 1, k, -8355712, this.textShadow);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    pGuiGraphics.drawString(this.font, "_", j1, k, l1, this.textShadow);
                }
            }
