...
public abstract class StructurePoolElement {
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(String pId, LiquidSettings pLiquidSettings) {
        return p_352032_ -> new SinglePoolElement(Either.left(ResourceLocation.parse(pId)), EMPTY, p_352032_, Optional.of(pLiquidSettings));
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(
        ...
        return p_352024_ -> new SinglePoolElement(Either.left(ResourceLocation.parse(pId)), pProcessors, p_352024_, Optional.of(pLiquidSettings));
    }
