...
public class V1460 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
        ...
        pSchema.register(map, "minecraft:area_effect_cloud", p_340685_ -> DSL.optionalFields("Particle", References.PARTICLE.in(pSchema)));
        ...
        pSchema.register(
            ...
            p_340683_ -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(References.VILLAGER_TRADE.in(pSchema))), V100.equipment(pSchema))
        );
        return map;
    }
