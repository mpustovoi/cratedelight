                    ...
                    .apply(
                        ...
                        (p_258484_, p_258485_, p_258486_, p_258487_, p_258488_, p_258489_, p_258490_) -> (p_352737_, p_352738_, p_352739_) -> {
                                p_352737_.getPoiManager()
                                    ...
                                    .filter(p_352725_ -> p_352725_.closerToCenterThan(p_352738_.position(), (double)pCloseEnoughDist))
                                    .or(
                                        () -> p_352737_.getPoiManager()
                                                .getRandom(
                                    ...
                                    .ifPresent(p_352753_ -> {
                                        ...
                                        if (!p_352753_.closerToCenterThan(p_352738_.position(), (double)pCloseEnoughDist)) {
                                            p_258484_.set(new WalkTarget(p_352753_, pSpeedModifier, pCloseEnoughDist));
                                        }
                                    });
                                return true;
                            }
