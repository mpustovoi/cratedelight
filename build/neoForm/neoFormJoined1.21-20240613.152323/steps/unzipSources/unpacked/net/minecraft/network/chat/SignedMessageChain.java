    ...
    public SignedMessageChain.Encoder encoder(Signer pSigner) {
        return p_337505_ -> {
            ...
            if (signedmessagelink == null) {
                ...
                return new MessageSignature(pSigner.sign(p_248065_ -> PlayerChatMessage.updateSignature(p_248065_, signedmessagelink, p_337505_)));
            }
        };
    }
        ...
        static SignedMessageChain.Decoder unsigned(UUID pId, BooleanSupplier pShouldEnforceSecureProfile) {
            return (p_337508_, p_337509_) -> {
                if (pShouldEnforceSecureProfile.getAsBoolean()) {
                    ...
                    return PlayerChatMessage.unsigned(pId, p_337509_.content());
                }
            };
        }
