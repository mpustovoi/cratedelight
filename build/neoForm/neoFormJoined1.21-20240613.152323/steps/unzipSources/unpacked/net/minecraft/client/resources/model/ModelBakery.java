...
public class ModelBakery {
    ...
    public ModelBakery(
        ...
        BlockStateModelLoader blockstatemodelloader = new BlockStateModelLoader(
            pBlockStateResources, pProfilerFiller, this.missingModel, pBlockColors, this::registerModelAndLoadDependencies
        );
    ...
    public void bakeModels(ModelBakery.TextureGetter pTextureGetter) {
        this.topLevelModels.forEach((p_351687_, p_351688_) -> {
            ...
            try {
                bakedmodel = new ModelBakery.ModelBakerImpl(pTextureGetter, p_351687_).bakeUncached(p_351688_, BlockModelRotation.X0_Y0);
    ...
    class ModelBakerImpl implements ModelBaker {
        ...
        ModelBakerImpl(ModelBakery.TextureGetter pTextureGetter, ModelResourceLocation pModelLocation) {
            this.modelTextureGetter = p_351691_ -> pTextureGetter.get(pModelLocation, p_351691_);
        }
        ...
        @Override
        @Nullable
        public BakedModel bakeUncached(UnbakedModel pModel, ModelState pState, Function<Material, TextureAtlasSprite> sprites) {
            if (pModel instanceof BlockModel blockmodel && blockmodel.getRootModel() == ModelBakery.GENERATION_MARKER) {
                return ModelBakery.ITEM_MODEL_GENERATOR
                    ...
                    .bake(this, blockmodel, sprites, pState, false);
            }
