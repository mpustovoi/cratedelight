...
public class BlockPos extends Vec3i {
    ...
    public static BlockPos min(BlockPos pPos1, BlockPos pPos2) {
        return new BlockPos(
            Math.min(pPos1.getX(), pPos2.getX()), Math.min(pPos1.getY(), pPos2.getY()), Math.min(pPos1.getZ(), pPos2.getZ())
        );
    }

    public static BlockPos max(BlockPos pPos1, BlockPos pPos2) {
        return new BlockPos(
            Math.max(pPos1.getX(), pPos2.getX()), Math.max(pPos1.getY(), pPos2.getY()), Math.max(pPos1.getZ(), pPos2.getZ())
        );
    }
