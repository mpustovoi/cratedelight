...
public enum DyeColor implements StringRepresentable {
    ...
    private DyeColor(int pId, String pName, int pTextureDefuseColor, MapColor pMapColor, int pFireworkColor, int pTextColor) {
        ...
        this.dyesTag = net.minecraft.tags.ItemTags.create(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("c", "dyes/" + pName));
        this.dyedTag = net.minecraft.tags.ItemTags.create(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("c", "dyed/" + pName));
