    ...
    public void renderToBuffer(PoseStack pPoseStack, VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, int pColor) {
        if (this.young) {
            ...
            ImmutableList.of(this.head, this.leftEar, this.rightEar, this.nose)
                .forEach(p_349855_ -> p_349855_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pColor));
            pPoseStack.popPose();
            pPoseStack.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_349849_ -> p_349849_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pColor));
            pPoseStack.popPose();
        } else {
            pPoseStack.pushPose();
            ...
            ImmutableList.of(
                ...
                .forEach(p_349861_ -> p_349861_.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pColor));
            pPoseStack.popPose();
        }
    }
