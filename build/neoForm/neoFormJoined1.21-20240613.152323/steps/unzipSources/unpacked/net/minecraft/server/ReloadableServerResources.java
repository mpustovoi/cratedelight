...
public class ReloadableServerResources {
            ...
            .thenCompose(
                p_335211_ -> {
                    ReloadableServerResources reloadableserverresources = new ReloadableServerResources(
                        p_335211_.compositeAccess(), pEnabledFeatures, pCommandSelection, pFunctionCompilationLevel
                    );
    ...
    static class ConfigurableRegistryLookup implements HolderLookup.Provider {
        ...
        public <T> Optional<HolderLookup.RegistryLookup<T>> lookup(ResourceKey<? extends Registry<? extends T>> pRegistryKey) {
            return this.registryAccess.registry(pRegistryKey).map(p_324050_ -> this.createDispatchedLookup(p_324050_.asLookup(), p_324050_.asTagAddingLookup()));
        }

        private <T> HolderLookup.RegistryLookup<T> createDispatchedLookup(
            final HolderLookup.RegistryLookup<T> pLookup, final HolderLookup.RegistryLookup<T> pTagAddingLookup
        ) {
