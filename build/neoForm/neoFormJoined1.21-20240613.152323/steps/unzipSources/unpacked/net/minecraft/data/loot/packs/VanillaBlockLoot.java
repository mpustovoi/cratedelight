...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.DEEPSLATE_TILE_SLAB, p_344225_ -> this.createSlabItemTable(p_344225_));
        this.add(Blocks.DEEPSLATE_BRICK_SLAB, p_344249_ -> this.createSlabItemTable(p_344249_));
        this.add(Blocks.MUD_BRICK_SLAB, p_344213_ -> this.createSlabItemTable(p_344213_));
        ...
        this.add(Blocks.COPPER_DOOR, p_344205_ -> this.createDoorTable(p_344205_));
        this.add(Blocks.EXPOSED_COPPER_DOOR, p_344201_ -> this.createDoorTable(p_344201_));
        this.add(Blocks.WEATHERED_COPPER_DOOR, p_344199_ -> this.createDoorTable(p_344199_));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, p_344247_ -> this.createDoorTable(p_344247_));
        this.add(Blocks.WAXED_COPPER_DOOR, p_344221_ -> this.createDoorTable(p_344221_));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, p_344219_ -> this.createDoorTable(p_344219_));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, p_344208_ -> this.createDoorTable(p_344208_));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, p_344217_ -> this.createDoorTable(p_344217_));
                                    ...
                                    LootItem.lootTableItem(Items.NETHER_WART)
                                        .apply(
                                            SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))
                                                .when(
                                                    LootItemBlockStatePropertyCondition.hasBlockStateProperties(p_344239_)
        ...
        this.add(
            ...
            p_344203_ -> this.createSilkTouchDispatchTable(
                    ...
                    LootItem.lootTableItem(Items.AMETHYST_SHARD)
                        ...
                        .otherwise(
                            (LootPoolEntryContainer.Builder<?>)this.applyExplosionDecay(
                                p_344203_, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                            )
                        )
                )
        );
