...
public record ServerLinks(List<ServerLinks.Entry> entries) {
    ...
    public Optional<ServerLinks.Entry> findKnownType(ServerLinks.KnownLinkType pType) {
        return this.entries.stream().filter(p_350399_ -> p_350399_.type.map(p_350899_ -> p_350899_ == pType, p_350339_ -> false)).findFirst();
    }
    ...
    public static enum KnownLinkType {
        ...
        private KnownLinkType(int pId, String pName) {
            this.id = pId;
            this.name = pName;
        }
