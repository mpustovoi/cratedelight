        ...
        if (pLevel > enchantment.getMaxLevel()) {
                ...
                if (entity instanceof LivingEntity) {
                    ...
                    if (!itemstack.isEmpty()) {
                        if (enchantment.canEnchant(itemstack)
                            && EnchantmentHelper.isEnchantmentCompatible(EnchantmentHelper.getEnchantmentsForCrafting(itemstack).keySet(), pEnchantment)) {
            ...
            if (i == 0) {
                ...
                if (pTargets.size() == 1) {
                    ...
                    pSource.sendSuccess(
                        () -> Component.translatable("commands.enchant.success.multiple", Enchantment.getFullname(pEnchantment, pLevel), pTargets.size()),
                        true
                    );
                }
