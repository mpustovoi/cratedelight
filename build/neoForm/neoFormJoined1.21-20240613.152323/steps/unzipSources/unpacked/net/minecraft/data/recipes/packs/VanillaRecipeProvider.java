...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        nineBlockStorageRecipesRecipesWithCustomUnpacking(
            pRecipeOutput, RecipeCategory.MISC, Items.BONE_MEAL, RecipeCategory.BUILDING_BLOCKS, Items.BONE_BLOCK, "bone_meal_from_bone_block", "bonemeal"
        );
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.GOLDEN_SWORD)
            ...
            .save(pRecipeOutput);
        nineBlockStorageRecipesRecipesWithCustomUnpacking(
            pRecipeOutput, RecipeCategory.MISC, Items.GOLD_INGOT, RecipeCategory.BUILDING_BLOCKS, Items.GOLD_BLOCK, "gold_ingot_from_gold_block", "gold_ingot"
        );
        nineBlockStorageRecipesWithCustomPacking(
            pRecipeOutput, RecipeCategory.MISC, Items.GOLD_NUGGET, RecipeCategory.MISC, Items.GOLD_INGOT, "gold_ingot_from_nuggets", "gold_ingot"
        );
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, Items.IRON_HOE)
            ...
            .save(pRecipeOutput);
        nineBlockStorageRecipesRecipesWithCustomUnpacking(
            pRecipeOutput, RecipeCategory.MISC, Items.IRON_INGOT, RecipeCategory.BUILDING_BLOCKS, Items.IRON_BLOCK, "iron_ingot_from_iron_block", "iron_ingot"
        );
        nineBlockStorageRecipesWithCustomPacking(
            pRecipeOutput, RecipeCategory.MISC, Items.IRON_NUGGET, RecipeCategory.MISC, Items.IRON_INGOT, "iron_ingot_from_nuggets", "iron_ingot"
        );
        ...
        smithingTrims().forEach(p_307153_ -> trimSmithing(pRecipeOutput, p_307153_.template(), p_307153_.id()));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, Items.MACE, 1)
            ...
            .save(pRecipeOutput);
        doorBuilder(Blocks.COPPER_DOOR, Ingredient.of(Items.COPPER_INGOT)).unlockedBy(getHasName(Items.COPPER_INGOT), has(Items.COPPER_INGOT)).save(pRecipeOutput);
    ...
    public static Stream<VanillaRecipeProvider.TrimTemplate> smithingTrims() {
        return Stream.of(
            ...
            .map(
                p_349916_ -> new VanillaRecipeProvider.TrimTemplate(p_349916_, ResourceLocation.withDefaultNamespace(getItemName(p_349916_) + "_smithing_trim"))
            );
    }
