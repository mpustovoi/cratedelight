...
public record ChatTypeDecoration(String translationKey, List<ChatTypeDecoration.Parameter> parameters, Style style) {
    ...
    public static enum Parameter implements StringRepresentable {
        ...
        public static final StreamCodec<ByteBuf, ChatTypeDecoration.Parameter> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, p_348120_ -> p_348120_.id);
        private final int id;
        private final String name;
        private final ChatTypeDecoration.Parameter.Selector selector;

        private Parameter(int pId, String pName, ChatTypeDecoration.Parameter.Selector pSelector) {
            this.id = pId;
            this.name = pName;
