...
public class BlockRenderDispatcher implements ResourceManagerReloadListener {
    ...
    public void renderBreakingTexture(BlockState pState, BlockPos pPos, BlockAndTintGetter pLevel, PoseStack pPoseStack, VertexConsumer pConsumer, net.neoforged.neoforge.client.model.data.ModelData modelData) {
        if (pState.getRenderShape() == RenderShape.MODEL) {
            ...
            this.modelRenderer
                .tesselateBlock(pLevel, bakedmodel, pState, pPos, pPoseStack, pConsumer, true, this.random, i, OverlayTexture.NO_OVERLAY, modelData, null);
        }
    }
            ...
            switch (rendershape) {
                case MODEL:
                    ...
                    this.modelRenderer
                        .renderModel(
                            pPoseStack.last(),
                            pBufferSource.getBuffer(renderType != null ? renderType : net.neoforged.neoforge.client.RenderTypeHelper.getEntityRenderType(rt, false)),
                            pState,
                            bakedmodel,
                            f,
                            f1,
                ...
                case ENTITYBLOCK_ANIMATED:
                    ...
                    net.neoforged.neoforge.client.extensions.common.IClientItemExtensions.of(stack).getCustomRenderer().renderByItem(stack, ItemDisplayContext.NONE, pPoseStack, pBufferSource, pPackedLight, pPackedOverlay);
            }
        }
    }
