...
public class Registries {
    ...
    public static String elementsDirPath(ResourceKey<? extends Registry<?>> pRegistryKey) {
        return net.neoforged.neoforge.common.CommonHooks.prefixNamespace(pRegistryKey.location());
    }

    public static String tagsDirPath(ResourceKey<? extends Registry<?>> pRegistryKey) {
        return "tags/" + net.neoforged.neoforge.common.CommonHooks.prefixNamespace(pRegistryKey.location());
    }
}
