                                ...
                                p_176343_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176339_ -> this.select(
                                                    (T1)p_125404_, (T2)p_176343_, (T3)p_176339_, pPropertyValuesToVariantMapper.apply((T1)p_125404_, (T2)p_176343_, (T3)p_176339_)
                                                )
                                        )
                            )
                );
                                ...
                                p_176331_ -> this.property3
                                        ...
                                        .forEach(
                                            p_176327_ -> this.select(
                                                    (T1)p_176334_, (T2)p_176331_, (T3)p_176327_, pPropertyValuesToVariantsMapper.apply((T1)p_176334_, (T2)p_176331_, (T3)p_176327_)
                                                )
                                        )
                            )
                );
