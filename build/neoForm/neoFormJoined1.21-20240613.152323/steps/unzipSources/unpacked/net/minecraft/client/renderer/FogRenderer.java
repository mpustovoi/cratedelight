...
public class FogRenderer {
    ...
    public static void setupFog(Camera pCamera, FogRenderer.FogMode pFogMode, float pFarPlaneDistance, boolean pShouldCreateFog, float pPartialTick) {
        ...
        net.neoforged.neoforge.client.ClientHooks.onFogRender(pFogMode, fogtype, pCamera, pPartialTick, pFarPlaneDistance, fogrenderer$fogdata.start, fogrenderer$fogdata.end, fogrenderer$fogdata.shape);
    }
