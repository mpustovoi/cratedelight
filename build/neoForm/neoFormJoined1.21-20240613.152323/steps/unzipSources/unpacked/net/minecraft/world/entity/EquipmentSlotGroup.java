...
public enum EquipmentSlotGroup implements StringRepresentable {
    ...
    private EquipmentSlotGroup(int pId, String pKey, Predicate<EquipmentSlot> pPredicate) {
        this.id = pId;
        this.key = pKey;
        this.predicate = pPredicate;
    }

    private EquipmentSlotGroup(int pId, String pKey, EquipmentSlot pSlot) {
        this(pId, pKey, p_330549_ -> p_330549_ == pSlot);
    }
