...
public class ItemModelGenerators {
    ...
    private void generateItemWithOverlay(Item pItem) {
        this.generateLayeredItem(
            ModelLocationUtils.getModelLocation(pItem), TextureMapping.getItemTexture(pItem), TextureMapping.getItemTexture(pItem, "_overlay")
        );
    }
            ...
            if (pArmorItem.getMaterial().is(ArmorMaterials.LEATHER)) {
                ModelTemplates.TWO_LAYERED_ITEM
                    .create(
                        ...
                        this.output,
                        (p_323130_, p_323131_) -> this.generateBaseArmorTrimTemplate(p_323130_, p_323131_, pArmorItem.getMaterial())
                    );
            } else {
                ModelTemplates.FLAT_ITEM
                    .create(
                        ...
                        this.output,
                        (p_323127_, p_323128_) -> this.generateBaseArmorTrimTemplate(p_323127_, p_323128_, pArmorItem.getMaterial())
                    );
            }
