...
public class MushroomCow extends Cow implements Shearable, VariantHolder<MushroomCow.MushroomType> {
    ...
    public void addAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (this.stewEffects != null) {
            SuspiciousStewEffects.CODEC.encodeStart(NbtOps.INSTANCE, this.stewEffects).ifSuccess(p_297973_ -> pCompound.put("stew_effects", p_297973_));
        }
    }
    ...
    public void readAdditionalSaveData(CompoundTag pCompound) {
        ...
        if (pCompound.contains("stew_effects", 9)) {
            SuspiciousStewEffects.CODEC.parse(NbtOps.INSTANCE, pCompound.get("stew_effects")).ifSuccess(p_330058_ -> this.stewEffects = p_330058_);
        }
    }
