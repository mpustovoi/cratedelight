...
public class BeeDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
    ...
    private void renderFlowerInfos(PoseStack pPoseStack, MultiBufferSource pBuffer) {
        ...
        map.forEach((p_339302_, p_339303_) -> {
            ...
            int i = 1;
            renderTextOverPos(pPoseStack, pBuffer, set.toString(), p_339302_, i++, -256);
            renderTextOverPos(pPoseStack, pBuffer, "Flower", p_339302_, i++, -1);
            float f = 0.05F;
            DebugRenderer.renderFilledBox(pPoseStack, pBuffer, p_339302_, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
        });
    }
